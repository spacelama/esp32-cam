...
void http_setbright() {
    ...
    clockDisplay.setBrightness(bright);
...
//        clockDisplay.drawColon(!blinkColon,2,0x4);
    ...
    clockDisplay.writeDigitRaw(2,colon_bits);
}
...
void blink() {
    ...
    clockDisplay.drawColon(blinkPatternIndex);
}
...
//  setenv("TZ", "CST+6CDT,M3.2.0/2,M11.1.0/2", 1);
    ...
    configTime(MYTZ, "au.pool.ntp.org");
        ...
        if (seconds % 8 >= 4) {
            if (direction) {
                ...
                for (int i=0;i<4;i++) {
                    ...
                    clockDisplay.writeDigitRaw(d, enc);
                }
                custom_display = true;
